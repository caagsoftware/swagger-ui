...
templates['main'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "  <div class=\"info_title\">"
    ...
    + "\n  <div>\n    <b><h2>Authentication</h2></b>\n    <p>For authentication, you will need to use the following tokens:</p>\n\n    <b>Tenant Token:</b> it's the token that identifies your company in the system. <br>\n    <b>User Token:</b> it's the token that identifies the user with the API. <br> <br>\n\n    <p> So, to authenticate with the API you have to generate and send in the header of the request an <b>Authentication Token</b>. \n          To generate the authentication token you have to encode in base 64 the Tenant Token and User Token as it follows:</p>\n\n    <p> generated_token = <b>tenant_token:user_token</b>\n    <p> Authorization = Basic generated_token </p>\n\n    <p> You can encode it in base64 on this website <a href=\"https://www.base64encode.org/\"> https://www.base64encode.org/ </a></p> \n    <p> Depending on the region where the servers are hosted, we have the following API endpoints: </p>\n\n    <ul>\n      <li>\n        <b>America:</b> https://api.caagcrm.com/api/\n      </li>\n      <li>\n        <b>America 2:</b> https://api-america-2.caagcrm.com/api-america-2/\n      </li>\n      <li>\n        <b>Europe:</b> https://api-europe.caagcrm.com/api-europe/\n      </li>\n      <li>\n        <b>Asia:</b> https://api-asia.caagcrm.com/api-asia/\n      </li>\n    </ul>\n    <br>\n    <p> Please contact us to confirm the region of your installation </p>\n\n    <ul>\n      <li>\n        If your domain to access the platform ends with caagcrm.com, your region is <b> America </b>\n      </li>\n      <li>\n        If your domain to access the platform ends with hqrentals.app, your region is <b> America 2 </b>\n      </li>\n      <li>\n        If your domain to access the platform ends with hqrentals.eu, your region is <b> Europe </b>\n      </li>\n      <li>\n        If your domain to access the platform ends with hqrentals.asia, your region is <b> Asia </b>\n      </li>\n    </ul>\n\n    <hr>\n  </div>\n  "
  ...
  return "<br><div><div class='info_name' style=\"display: inline\" data-sw-translate>Created by </div> "
...
templates['oauth2'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"key_input_container\">\n    <div>\n        <div class=\"key_auth__field\">\n            <span class=\"key_auth__label\">Tenant Token:</span>\n            <input class=\"oauth-client-id\" type=\"text\" name=\"client-id\" style=\"width: 85%;\">\n        </div>\n        <div class=\"key_auth__field\">\n            <span class=\"key_auth__label\">User Token:</span>\n            <input class=\"oauth-client-secret\" type=\"text\" name=\"client-secret\" style=\"width: 85%;\">\n        </div>\n    </div>\n</div>";
},"useData":true});
templates['operation'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "          <div class=\"response-class\">\n            <h4><span data-sw-translate>Response Class</span> (<span data-sw-translate>Status</span> "
    ...
    + ")</h4>\n              "
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.successDescription : depth0),{"name":"if","hash":{},"fn":container.program(12, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
  ...
  return "          <h4 data-sw-translate>Headers</h4>\n          <table class=\"headers\">\n            <thead>\n              <tr>\n                <th style=\"width: 100px; max-width: 100px\" data-sw-translate>Header</th>\n                <th style=\"width: 310px; max-width: 310px\" data-sw-translate>Description</th>\n                <th style=\"width: 200px; max-width: 200px\" data-sw-translate>Type</th>\n                <th style=\"width: 320px; max-width: 320px\" data-sw-translate>Other</th>\n              </tr>\n            </thead>\n            <tbody>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.headers : depth0),{"name":"each","hash":{},"fn":container.program(15, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "            </tbody>\n          </table>\n";
  ...
  return "  <ul class='operations' >\n    <li class='"
    ...
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.security : depth0),{"name":"if","hash":{},"fn":container.program(9, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.type : depth0),{"name":"if","hash":{},"fn":container.program(11, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.headers : depth0),{"name":"if","hash":{},"fn":container.program(14, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "\n        <form accept-charset='UTF-8' class='sandbox'>\n          <div style='margin:0;padding:0;display:inline'></div>\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.parameters : depth0),{"name":"if","hash":{},"fn":container.program(17, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.responseMessages : depth0),{"name":"if","hash":{},"fn":container.program(19, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.isReadOnly : depth0),{"name":"if","hash":{},"fn":container.program(21, data, 0),"inverse":container.program(23, data, 0),"data":data})) != null ? stack1 : "")
    + "        </form>\n        <div class='response' style='display:none'>\n          <h4 class='curl'>Curl</h4>\n          <div class='block curl'></div>\n          <h4 data-sw-translate>Request URL</h4>\n          <div class='block request_url'></div>\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.showRequestHeaders : depth0),{"name":"if","hash":{},"fn":container.program(25, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
